        ...
        <div className="max-w-md w-full">
          <div className="bg-white border border-zinc-200/80 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col">
            ...
            <p className="text-xs text-zinc-500 mb-6 font-medium">
              Get your secret X-API-Key to start synthesizing review intelligence.
            </p>

            <form className="space-y-4">
              <div className="space-y-1">
                <label htmlFor="name" className="text-[10px] font-bold text-zinc-400 font-mono uppercase tracking-wider block">
                  Name
                </label>
                <input
                  id="name"
